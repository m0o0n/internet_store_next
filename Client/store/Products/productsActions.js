...
export const getAllProductsThunk = createAsyncThunk(
    ...
    async (thunkAPI) => {
        try {
            ...
            return thunkAPI.rejectWithValue(`An error occured can't get products: ${e.message}`)
        }
    }
)
...
export const createProductsThunk = createAsyncThunk(
    ...
    async (thunkAPI) => {
        try {
            const {name, price1, price10, price50, typeId, brandCountryId, img, info} = thunkAPI
            ...
            return thunkAPI.rejectWithValue(`An error occured can't create product: ${e.message}`)
        }
    }
)